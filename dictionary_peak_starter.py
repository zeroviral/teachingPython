...
peak["summit_log"].append("Jeremy")
print(peak)


# Let's rename "height" to "elevation":
# Remove "height" from the dict and store the result in a variable.
new_height = peak.pop("height")
print(peak)



# Use the value for "height" and store it in the dict under the key "elevation"
peak["elevation"] = new_height
print(peak)
